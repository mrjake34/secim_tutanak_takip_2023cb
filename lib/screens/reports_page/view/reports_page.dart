...
class _ReportsPageState extends State<ReportsPage> {
  ServiceStatus serviceStatus = NetworkLoading();
      ...
      child: BlocProvider(
        ...
        child: BlocBuilder<ReportsBloc, ReportsState>(
          builder: (context, state) {
            context.read<ReportsBloc>().add(ServiceEnabled());
            // print(state.serviceStatus);
            if (state.serviceStatus is NetworkReady) {
              return Scaffold(
                body: BuildScaffold(
                  state: state,
                ),
              );
            } else if (state.serviceStatus is NetworkFailed) {
              return Center(
                child: Padding(
            ...
            } else if (state.serviceStatus is NetworkNotReady) {
              return Center(
                child: Padding(
                  padding: const EdgeInsets.all(pagePadding),
                  child: Column(
